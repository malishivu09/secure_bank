...
<c:url var="creditUrl" value="/MerchantHome/credit/send"></c:url>
...
<%-- <form id="integerForm" class="form-horizontal" data-bv-feedbackicons-valid="glyphicon glyphicon-ok"
 ...
 <form:form class="navbar-form navbar-left" role="search" action ="${creditUrl}" commandName="amount">
  <div class="form-group">
    <input  id="creditamountTransfer"type="text" class="form-control" name="amount_merchant" placeholder="Enter amount"/>
  </div>
  <button type="button" onclick="creditmerchantTransfer()" class="btn btn-default">Submit</button>
</form:form>
